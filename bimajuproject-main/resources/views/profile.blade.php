                    ...
                    <div class="md:col-span-2 bg-white shadow rounded-lg p-6">
                        ...
                        <form action="#" method="POST" class="space-y-4">
                            ...
                            <div>
                                ...
                                <input type="text" name="name" value="Sarah Wijaya"
                            ...
                            <div>
                                ...
                                <div class="relative">
                                    ...
                                    <input type="email" name="email" value="sarah.wijaya@email.com"
                    ...
                    <div class="bg-white shadow rounded-lg p-6">
                        ...
                        <ul class="space-y-3 text-sm text-gray-600">
                            <li class="flex items-center gap-2">
                                ...
                                <span class="ml-auto font-medium">15 Januari 2024</span>
                            </li>
                            <li class="flex items-center gap-2">
                                ⏰ <span>Login terakhir</span>
                                <span class="ml-auto font-medium">Hari ini, 14:30</span>
                            </li>
                            <li class="flex items-center gap-2">
                                🛡 <span>Status</span>
                                <span class="ml-auto font-medium">Learner</span>
                            </li>
                        </ul>
                    </div>
                </div>
