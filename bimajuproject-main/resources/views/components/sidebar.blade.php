<div class="bg-white min-w-64 border-r transition-all duration-300"
     x-data="{
         collapsed: false,
         openBusiness: JSON.parse(localStorage.getItem('openBusiness') || 'false')
     }"
     x-init="$watch('openBusiness', value => localStorage.setItem('openBusiness', JSON.stringify(value)))">
    {{-- Header --}}
            ...
            <ul x-show="openBusiness" class="ml-4 mt-1 space-y-1">
                <li>
                    <a href="{{ url('/finance') }}" class="flex items-center gap-2 px-2 py-2 rounded-md hover:bg-gray-100">
                        ...
                        <span x-show="!collapsed" class="font-semibold">Finance</span>
                    </a>
                </li>
                <li>
                    <a href="{{ url('/hpp-calculator') }}" class="flex items-center gap-2 px-2 py-2 rounded-md hover:bg-gray-100">
                        ...
                        <span x-show="!collapsed" class="font-semibold">HPP Calculator</span>
                    </a>
                </li>
                <li>
                    <a href="{{ url('/recipes') }}" class="flex items-center gap-2 px-2 py-2 rounded-md hover:bg-gray-100">
                        <img src="{{asset('assets/images/chef-hat.png')}}" alt="" class="w-6 h-6">
                        <span x-show="!collapsed" class="font-semibold">Recipes</span>
                    </a>
                </li>
            </ul>
        </div>
            ...
            <ul class="space-y-1 mt-1">
                <li>
                    <a href="{{ url('/consultation') }}" class="flex items-center gap-2 px-2 py-2 rounded-md hover:bg-gray-100">
                        ...
                        <span x-show="!collapsed" class="font-semibold">Consultation</span>
    ...
    <div class="mt-auto p-2">
        <ul class="space-y-1">
            <li>
                <a href="{{ url('/profile') }}" class="flex items-center gap-2 px-2 py-2 rounded-md hover:bg-gray-100">
                    <svg xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 24 24" stroke-width="1.5" stroke="currentColor" class="size-6">
            ...
            <li>
                <a href="{{ url('/setting') }}" class="flex items-center gap-2 px-2 py-2 rounded-md hover:bg-gray-100">
                    <svg xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 24 24" stroke-width="1.5" stroke="currentColor" class="size-6">
            ...
            <li>
                <a href="{{ url('/subscription') }}" class="flex items-center gap-2 px-2 py-2 rounded-md hover:bg-gray-100">
                    <svg xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 24 24" stroke-width="1.5" stroke="currentColor" class="size-6">
                    ...
                    <span x-show="!collapsed">Subscription</span>
                </a>
            </li>
        </ul>
    </div>
